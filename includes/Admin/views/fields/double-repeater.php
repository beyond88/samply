    ...
    <tbody id="append_body">
        ...
        <tr valign="top">
            <td class="middle-align">
                <input type="text" name="<?php echo esc_html($this->_optionName."[".$value['name']."]"); ?>[qty][]" maxlength="30" class="timezone_string wfps-meta-field playfield" placeholder="<?php esc_html_e( 'Quantity', 'samply' ); ?>" value="<?php echo esc_attr($val); ?>">               
                <input type="text" name="<?php echo esc_html($this->_optionName."[".$value['name']."]"); ?>[price][]" maxlength="30" class="timezone_string wfps-meta-field playfield" placeholder="<?php esc_html_e( 'Price', 'samply' ); ?>" value="<?php echo esc_attr($setting_options[$value['name']]['price'][$i]); ?>">
        ...
        <tr valign="top">
            <td class="middle-align">
                <input type="text" name="<?php echo esc_html($this->_optionName."[".$value['name']."]"); ?>[qty][]" maxlength="30" value="" class="timezone_string wfps-meta-field playfield" placeholder="<?php esc_html_e( 'Quantity', 'samply' ); ?>">               
                <input type="text" name="<?php echo esc_html($this->_optionName."[".$value['name']."]"); ?>[price][]" maxlength="30" value="" class="timezone_string wfps-meta-field playfield" placeholder="<?php esc_html_e( 'Price', 'samply' ); ?>">
            </td>
        </tr>    
        <?php } ?>
    </tbody>
        ...
        <td class="middle-align">
            <div class="wfps-click-area-wrapper">
                ...
                <label for="add-field" class="wfps-group-field-add" >
                    ...
                    <span class="rx_add_field_label"><?php esc_html_e( 'Add Sample Price', 'samply' );?></span>
