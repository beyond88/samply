    ...
    <tbody id="append_body">
        ...
        <tr valign="top">
            <td class="middle-align">
                <input type="text" name="<?php echo $this->_optionName."[".$value['name']."]"; ?>[qty][]" maxlength="30" class="timezone_string wfps-meta-field playfield" placeholder="<?php esc_html_e( 'Quantity', 'samply' ); ?>" value="<?php echo $val; ?>">               
                <input type="text" name="<?php echo $this->_optionName."[".$value['name']."]"; ?>[price][]" maxlength="30" class="timezone_string wfps-meta-field playfield" placeholder="<?php esc_html_e( 'Price', 'samply' ); ?>" value="<?php echo $setting_options[$value['name']]['price'][$i]; ?>">
        ...
        <tr valign="top">
            <td class="middle-align">
                <input type="text" name="<?php echo $this->_optionName."[".$value['name']."]"; ?>[qty][]" maxlength="30" value="" class="timezone_string wfps-meta-field playfield" placeholder="<?php esc_html_e( 'Quantity', 'samply' ); ?>">               
                <input type="text" name="<?php echo $this->_optionName."[".$value['name']."]"; ?>[price][]" maxlength="30" value="" class="timezone_string wfps-meta-field playfield" placeholder="<?php esc_html_e( 'Price', 'samply' ); ?>">
            </td>
        </tr>    
        <?php } ?>
    </tbody>
